...
public class VerPeticiones extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VerPeticiones frame = new VerPeticiones();
	...
	public VerPeticiones() {
		setTitle("Peticiones");
		setIconImage(Toolkit.getDefaultToolkit().getImage(VerPeticiones.class.getResource("/resources/Logo lab IOO.jpg")));
